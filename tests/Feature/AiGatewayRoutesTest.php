...
class AiGatewayRoutesTest extends TestCase
{
    ...
    public function test_chat_is_blocked_for_user_without_active_subscription(): void
    {
        [$user] = $this->makeTenantUser(withSubscription: false);
     ...
     */
    private function makeTenantUser(bool $withSubscription = true): array
    {
    ...
    /**
     * The /api/ai/* routes sit behind RequireActiveSubscription, so a site user needs a
     * paid period with remaining tokens before the gateway itself can be exercised.
     */
    private function giveActiveSubscription(User $user): void
    {
        $plan = Plan::query()->create([
            ...
            'slug' => 'gateway-test',
            'name' => 'Gateway Test',
            'description' => 'Plan used by gateway tests.',
            'monthly_token_limit' => 1_000_000,
            'price_cents' => 300,
            'currency' => 'usd',
            'openai_usd_per_million' => 1,
            'markup_multiplier' => 3,
            'features' => ['RAG chat access'],
            'is_active' => true,
        ...
        $subscription = Subscription::query()->create([
            ...
            'plan_id' => $plan->id,
            'status' => 'active',
            'stripe_payment_intent_id' => 'pi_gateway_test',
            'tokens_included' => $plan->monthly_token_limit,
            'tokens_used' => 0,
