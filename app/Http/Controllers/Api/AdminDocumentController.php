        ...
        if (!$request->hasFile('file')) {
            ...
            if ($contentLength > 0) {
                return response()->json([
                    'detail' => 'File upload failed. The file may exceed the PHP upload limit (currently '.ini_get('upload_max_filesize').'). Maximum allowed by the app is 50MB.',
                ], 413);
            }

            return response()->json(['detail' => 'A file is required.'], 400);
        }
