    ...
    <script>
        ...
        const endpointDefinitions = [
            ...
            },
            {
                ...
                useAuth: true,
                description: 'Get OpenAI API key status, source, and masked preview.',
                fields: [],
            },
            {
                key: 'adminSystemConfigGetProjectApi',
                label: '/api/admin/system-config/project-api',
                method: 'GET',
                endpoint: '/api/admin/system-config/project-api',
                useAuth: true,
                description: 'Get configured Project backend base URL status.',
                fields: [],
            },
            {
                key: 'adminSystemConfigGetRuntime',
                label: '/api/admin/system-config/runtime',
                method: 'GET',
                endpoint: '/api/admin/system-config/runtime',
                useAuth: true,
                description: 'Get basic Laravel runtime configuration status.',
                fields: [],
            },
            {
                key: 'adminSystemConfigGetDatabase',
                label: '/api/admin/system-config/database',
                method: 'GET',
                endpoint: '/api/admin/system-config/database',
                useAuth: true,
                description: 'Get database connection configuration summary for Laravel and Project DB.',
                fields: [],
            },
            {
                key: 'adminSystemConfigGetAuthMode',
                label: '/api/admin/system-config/auth-mode',
                method: 'GET',
                endpoint: '/api/admin/system-config/auth-mode',
                useAuth: true,
                description: 'Get current Laravel admin auth mode summary.',
                fields: [],
            },
            {
                key: 'adminSystemConfigGetStorage',
                label: '/api/admin/system-config/storage',
                method: 'GET',
                endpoint: '/api/admin/system-config/storage',
                useAuth: true,
                description: 'Get storage disk and public storage link status.',
                fields: [],
            },
            {
            ...
            {
                key: 'adminSystemConfigClearOpenAiKey',
                label: '/api/admin/system-config/openai-api-key (clear override)',
                method: 'DELETE',
                endpoint: '/api/admin/system-config/openai-api-key',
                useAuth: true,
                description: 'Clear the database override and fall back to env configuration.',
                fields: [],
            },
            {
